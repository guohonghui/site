...
<div class="layui-layout layui-layout-admin">
            ...
            <ul class="layui-nav top_menu">
                <li class="layui-nav-item" pc>
                    ...
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:" data-url="${base}/userinfo"><i class="iconfont icon-zhanghu" data-icon="icon-zhanghu"></i><cite>个人资料</cite></a></dd>
                        <dd><a href="javascript:" data-url="${base}/changePassword"><i class="iconfont icon-shezhi1" data-icon="icon-shezhi1"></i><cite>修改密码</cite></a></dd>
    ...
    <div class="layui-footer footer">
        <p>Copyright © 2018后台管理 Design By Simple <a href="http://www.miibeian.gov.cn" target="_blank">闽ICP备18025510号 </a></p>
    </div>
</div>
<script>
    var baseUrl = "${base}";
